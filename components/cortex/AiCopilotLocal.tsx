...
export default function AiCopilotLocal({ onAction }: { onAction?: (a: any) => void }) {
  ...
  return (
    <div className="bg-midnight p-3 rounded shadow">
      ...
      <div className="flex gap-2">
        ...
        <button onClick={submit} className="bg-helix px-3 py-2 rounded text-midnight">Ask</button>
      </div>
    </div>
  );
}
